...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM buses LIMIT 1) THEN
        ...
        (1,  'BUS 03', NULL, 'BLUE', 'Kandirpar → Campus via Policeline', 1),
        (2,  'BUS 04', NULL, 'BLUE', 'Kandirpar → Campus via Policeline', 1),
        (3,  'BUS 05', NULL, 'BLUE', 'Kandirpar → Campus via Policeline', 1),
        (4,  'BUS 11', NULL, 'BLUE', 'Dhormopur → Campus', 1),
        (5,  'BUS 25', NULL, 'BLUE', 'Campus → Policeline → Eidgah', 1),
        (6,  'BUS 31', NULL, 'BLUE', 'Kandirpar → Campus', 1),
        (7,  'BUS 32', NULL, 'BLUE', 'Kandirpar → Campus via Tomsombridge', 1),
        (8,  'BUS 33', NULL, 'BLUE', 'Kandirpar → Campus via Tomsombridge', 1),
        (9,  'BUS 06', NULL, 'TEACHER', 'Policeline → Campus via Tomsombridge', 1),
        (10, 'BUS 08', NULL, 'TEACHER', 'Kandirpar → Campus', 1),
        (11, 'BUS 14', NULL, 'STAFF', 'Kandirpar → Campus', 1);
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM schedules LIMIT 1) THEN
        ...
        (1, (SELECT id FROM buses WHERE bus_number = 'BUS 03'), '07:00', '08:00', 'UP', 'Kandirpar', 'Campus', 'SUN-THU', 1),
        (2, (SELECT id FROM buses WHERE bus_number = 'BUS 03'), '16:00', '17:00', 'DOWN', 'Campus', 'Kandirpar', 'SUN-THU', 1),
        (3, (SELECT id FROM buses WHERE bus_number = 'BUS 04'), '07:15', '08:15', 'UP', 'Kandirpar', 'Campus', 'SUN-THU', 1),
        (4, (SELECT id FROM buses WHERE bus_number = 'BUS 04'), '16:15', '17:15', 'DOWN', 'Campus', 'Kandirpar', 'SUN-THU', 1),
        (5, (SELECT id FROM buses WHERE bus_number = 'BUS 11'), '07:30', '08:30', 'UP', 'Dhormopur', 'Campus', 'SUN-THU', 1),
        (6, (SELECT id FROM buses WHERE bus_number = 'BUS 11'), '16:30', '17:30', 'DOWN', 'Campus', 'Dhormopur', 'SUN-THU', 1);
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM notices LIMIT 1) THEN
        ...
        (1, 'Welcome to CoU Bus Tracker', 'This system provides real-time bus tracking for Comilla University.', 168, 1, NULL);
